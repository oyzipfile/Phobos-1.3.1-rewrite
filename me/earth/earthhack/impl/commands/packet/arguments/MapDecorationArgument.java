...
public class MapDecorationArgument
extends AbstractArgument<MapDecoration> {
    private static final PacketArgument<MapDecoration.Type> TYPE = new EnumArgument<MapDecoration.Type>(MapDecoration.Type.class);
    ...
    public MapDecoration fromString(String argument) throws ArgParseException {
        ...
        byte x = this.parseByte(split[0], "MapDecoration-X");
        byte y = this.parseByte(split[1], "MapDecoration-Y");
        byte rotation = this.parseByte(split[2], "MapDecoration-Rotation");
    ...
    private byte parseByte(String string, String message) throws ArgParseException {
        try {
