...
extends NoStackTraceException {
    ...
    public static long tryLong(String string, String message) throws ArgParseException {
        try {
    ...
    public static double tryDouble(String string, String message) throws ArgParseException {
        try {
