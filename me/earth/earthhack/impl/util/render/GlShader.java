...
implements Nameable {
    ...
    public void set(String uniformName, Matrix4f value) {
        ...
        GL20.glUniformMatrix4((int)this.createUniform(uniformName), (boolean)false, (FloatBuffer)buffer);
    }
    ...
    public void set(String uniformName, org.lwjgl.util.vector.Vector4f value) {
