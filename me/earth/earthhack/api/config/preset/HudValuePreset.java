...
public class HudValuePreset
extends ModulePreset<HudElement> {
    ...
    @Override
    public void apply() {
        HudElement module = (HudElement)this.getModule();
    ...
    protected void setSetting(HudElement module, Map.Entry<String, JsonElement> entry) {
